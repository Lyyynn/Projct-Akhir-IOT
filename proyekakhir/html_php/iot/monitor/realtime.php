            ...
            window.onload = function () {
                ...
                var updateChart = function (count) {
                    ...
                    $.getJSON("http://localhost/proyek/proyekakhir/html_php/iot/monitor/getdata.php", function (data) {
                        ...
                        if (suhu >= 30 && suhu < 31) {
                            document.getElementById("indikator").textContent = "Suhu : " + suhu.toString() + " PANAS : Lumayan lah "; beep();
                        }
                        if (suhu >= 31) {
                            document.getElementById("indikator").textContent = "Suhu : " + suhu.toString() + " SANGAT PANAS : Panas Bett "; beep(); beep(); beep();
                        }
